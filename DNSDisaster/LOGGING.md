...
DNS灾难恢复系统使用 **Serilog** 记录日志，同时输出到控制台和文件。
...
[2026-02-06 15:31:01 DBG] [2026-02-06 15:31:01] 首次检测DNS一致性: IP=5.6.7.8
```
...
```bash
# 修改目录权限
sudo chown -R root:root /opt/dns-disaster/logs/
